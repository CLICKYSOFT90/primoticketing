...
class Role extends BaseModel
{
    ...
    protected $fillable = [
        'id', 'roleName', 'permissions','roleType'
    ];
    ...
    public static function actionButtons($data){
        ...
        if(\Common::canUpdate("role")) {
          $return .= '<a class="" href="'.route('roles.edit', $data->id).'" title="Edit">
        ...
        if(\Common::canDelete("role")) {
           ...
           <form action="'.route('roles.destroy', $data->id).'" method="post" id="delete_form_'.$data->id.'">
