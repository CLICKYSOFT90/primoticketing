...
@section('title', 'View Account Group #'.$model->id)
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('accountGroups.index') }}"> Account Groups</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-footer">
                        <a href="{{route('accountGroups.index') }}" class="btn btn-raised btn-warning mr-1">
